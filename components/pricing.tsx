            ...
            <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-2 lg:gap-6 items-start lg:max-w-3xl pt-4">
              ...
              <div className="relative flex flex-col h-full p-6" data-aos="fade-right">
                <div className="mb-6">
                  ...
                  {/* <Link className="btn text-white bg-blue-500 hover:bg-blue-600 w-full shadow-sm" href="/signup">Join The Community</Link> */}
                </div>
              ...
              <div>
                ...
                <div className="mb-6">
                  ...
                  {/* <Link className="btn text-white bg-blue-500 hover:bg-blue-600 w-full shadow-sm" href="/signup">Start Free Trial</Link> */}
                </div>
                <div className="font-medium text-gray-100 mb-4"></div>
