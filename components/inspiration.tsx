          ...
          <div className="pb-12  text-center justify-center">
            <div className="relative text-center md:text-left justify-center  ">
              <div>
                ...
                <h2 className="h2 font-cabinet-grotesk text-center">Mission</h2>
              </div>

              <h5 className="h5 font-cabinet-grotesk max-w-3xl text-center justify-center m-auto">
                In the realm of technology, where innovation and advancement
                shape our future, there's a silent revolution taking place—one
                that is championing the role of women in this predominantly
                male-dominated industry. Among the trailblazers leading this
                charge is Tare, a foundation with a vision to inspire and
