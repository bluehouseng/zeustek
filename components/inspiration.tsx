        ...
        <div className="py-12 md:pt-32 md:pb-20">
          ...
          <div className="pb-12 md:pb-14">
            <div className="relative text-center md:text-left">
              ...
              <h2 className="h2 font-cabinet-grotesk">Zeustek inspirations</h2>
              <h5 className="h5 font-cabinet-grotesk">In the realm of technology, where innovation and advancement shape our future, there's a silent revolution taking place—one that is championing the role of women in this predominantly male-dominated industry. Among the trailblazers leading this charge is Zeustek, a tech company with a vision to inspire and empower women through technology.

Founded on the principle of inclusivity and diversity, Zeustek has been a beacon of change in the tech world. Recognizing the untapped potential and talent that women bring to the table, the company has made concerted efforts to break down barriers and create opportunities for women to thrive in the tech sector.</h5>
            </div>
          </div>
          {/* Content */}
          <div>
