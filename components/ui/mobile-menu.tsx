    ...
    return (
      <div className="md:hidden flex items-center justify-end">
        ...
        <nav
          id="mobile-nav"
          ref={mobileNav}
          className={`absolute top-full right-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out bg-white ${mobileNavOpen ? 'opacity-100 max-h-screen' : 'opacity-0 max-h-0'}`}
        >
          <ul className="border border-transparent rounded-lg px-4 py-1.5">
            ...
            <li>
              <Link className="flex font-medium text-sm text-black py-1.5" href="/testimonial">Testimonial</Link>
            </li>
          </ul>
        </nav>
      </div>
