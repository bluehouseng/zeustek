...
import Author01 from "@/public/images/tare.png";

export default function Header() {
  return (
    <header className="absolute w-full z-30 bg-white">
      <div className="px-2 sm:px-6 flex justify-center items-center h-16 md:h-20">
        {/* Site branding */}
        <div className="mr-auto m-3 mt-5">
          <Image src={Author01} alt="Your Image" width={80} height={80} />
        </div>
        {/* Desktop navigation */}
