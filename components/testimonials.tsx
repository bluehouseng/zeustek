                ...
                <div className="swiper-wrapper">
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    ...
                    <div className="relative">
                      ...
                      <h4 className="h3 font-cabinet-grotesk mb-4">I've been using this Community to track my ideas, and it's such a helpful and enjoyable product. Thanks for building it!</h4>
                      <div>
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    ...
                    <div className="relative">
                      ...
                      <h4 className="h3 font-cabinet-grotesk mb-4">If you want real marketing that works and effective implementation - Zeustek got you covered.</h4>
                      <div>
                        <a className="btn-sm text-white bg-blue-500 hover:bg-blue-600 group shadow-sm" href="#0">
                          Read Story <span className="tracking-normal text-blue-200 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span>
                        </a>
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    ...
                    <div className="relative">
                      ...
                      <h4 className="h3 font-cabinet-grotesk mb-4">This community has really helped our business in many different ways. I just can't get enough of this awesome company.</h4>
                      <div>
                        <a className="btn-sm text-white bg-blue-500 hover:bg-blue-600 group shadow-sm" href="#0">
                          Read Story <span className="tracking-normal text-blue-200 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span>
                        </a>
