                ...
                <div className="swiper-wrapper">
                    ...
                    <div className="shrink-0 relative inline-flex">
                      ...
                      <div className="absolute right-0 bottom-0 mr-4 mb-6">
                        ...
                        >
                          ...
                          >
                            <path
                              d="m5.063 0 3.495 4.475L12.601 0h2.454L9.696 5.931 16 14h-4.938L7.197 9.107 2.771 14H.316L6.05 7.658 0 0h5.063Zm-.74 1.347H2.866l8.875 11.232h1.36L4.323 1.347Z"
                              fill="#1D9BF0"
                              fillRule="nonzero"
                            />
                          </svg>
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    ...
                    <div className="relative">
                      ...
                      <h4 className="h3 font-cabinet-grotesk mb-4">
                        This community has really helped our business in many
