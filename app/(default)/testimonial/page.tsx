              ...
              <div className="grid gap-12 md:grid-cols-3 md:gap-x-6 md:gap-y-8 items-start">
                ...
                >
                  ...
                  <p className="font-200 text-gray-600 grow">
                    The women are exicted to learn and eager to apply the knowledge to their businesses.
                    It motivates them to learn, know more and apply the knowledge.
                  </p>
                  <footer className="text-sm flex items-center mt-4">
                    {/* <div className="flex shrink-0 mr-3">
                                            <a className="relative" href="#0">
                ...
                >
                  ...
                  <p className="text-gray-600 grow">
                    I have been a novice to the online space and as a result of this training, i gain exposure
                    and I am able to transact my business globally.
                  </p>
                  <footer className="text-sm flex items-center mt-4">
                    {/* <div className="flex shrink-0 mr-3">
                                            <a className="relative" href="#0">
