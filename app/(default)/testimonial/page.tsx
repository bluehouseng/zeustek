        ...
        <video className="w-full h-full  top-0 left-0" 
            ...
            src="https://res.cloudinary.com/draxf5wop/video/upload/v1714741031/testimony_b51s9d.mp4"></video>
                ...
                >
                  ...
                  <p className="text-gray-600 grow">
                    Business revolutionary platform is here to engage all the
                    marginalized population to utilize and leverage the power of
                    digital technology to scale up businesses.
                  </p>
                  <footer className="text-sm flex items-center mt-4">
                    <div className="flex shrink-0 mr-3">
                      <a className="relative" href="#0">
                ...
                >
                  ...
                  <p className="font-200 text-gray-600 grow">
                    Thanks to the digital marketing, our conversion rates have
                    doubled in a couple of weeks. We're seeing a significant
                    increase in leads and sales and it keeps going on."
                  </p>
                  <footer className="text-sm flex items-center mt-4">
                    {/* <div className="flex shrink-0 mr-3">
                                            <a className="relative" href="#0">
                ...
                <article className="flex flex-col h-full" data-aos="zoom-y-out">
                  ...
                  <p className="text-gray-600 grow">
                    Since implementing our new digital marketing strategy, our
                    website traffic has increased by over 50%. Our digital
                    marketing agency has really helped us reach our target
                ...
                >
                  ...
                  <p className="text-gray-600 grow">
                    Our brand struggled to gain traction online. Through digital
                    marketing, our brand awareness has skyrocketed and we're
                    seeing much higher engagement on social media
                  </p>
                  <footer className="text-sm flex items-center mt-4">
                    {/* <div className="flex shrink-0 mr-3">
                                            <a className="relative" href="#0">
